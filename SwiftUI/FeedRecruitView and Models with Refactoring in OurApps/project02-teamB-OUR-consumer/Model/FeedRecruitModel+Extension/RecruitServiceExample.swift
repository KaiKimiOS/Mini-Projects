    ...
    var body: some View {
        VStack {
            HStack(spacing: 15) {
                ...
                Button {
                    model.updateField(documentID: "\(selectID)", data: .init(creator: "백엔드팀", content: "\(changedContent)", postImagePaths: [] ))
                ...
                Button {
                    ...
                    model.addDocument(data: .init(creator: "WJ", content: "Test", location: "korean Seoul", privateSetting: true, reportCount: 0, postImagePaths: []))
